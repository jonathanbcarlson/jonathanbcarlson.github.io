...
#let resume_item(body) = {
  set text(size: 9pt, style: "normal", weight: "light")
...
#let honor_awards_item_header(
  ...
  pad[
    #justify_align[
      #resume_organization[#name_of_award]
    ][
      #resume_location[#location]
    ]
    #justify_align[
      #resume_position[#organization]
    ][
      #resume_time[#time_frame]
    ]
  ]
